  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl flex-shrink-0 px-8 py-6 md:w-[450px] bg-ter text-black"
            // style={{
            //   background:
          ...
          >
            <blockquote>
              ...
              ></div>
              <span className=" relative z-20 text-sm leading-[1.6] black font-normal">
                {item.quote}
              </span>
