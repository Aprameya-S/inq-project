...
const DashboardNav = (
  ...
  return (
    <div className="layout-wrapper">
            <nav className="navbar bg-white/40 dark:bg-[#0e0e10]/60 fixed top-0 min-w-full border-[#131417] dark:border-zinc-800 border-b transition-all py-1 sm:py-2 backdrop-blur z-50 sm:h-[60px] flex items-center">
              <div className="flex justify-between align-middle px-[20px] lg:px-[60px] static w-full">
                <div className="flex items-center gap-4">
                  ...
                  <svg className='mr-[-0px] sm:scale-[0.8] scale-[0.7]' width="34" height="32" viewBox="0 0 34 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className='hidden sm:block'>inq</span>
                  </Link>
                ...
                <div className="transition-all grid items-center">
