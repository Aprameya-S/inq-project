  ...
  return (
    <div className="grid items-center h-screen">
        ...
        <div className="">
          ...
          <h2 className='text-[18px] font-medium text-blue-600'>Role 2</h2>
        </div>
        <form onSubmit={handleSubmit}>
          ...
          <Link href={'SignIn/role2/forgotPassword'} className='text-blue-600 text-[12px]'>Forgot password?</Link><br/>
